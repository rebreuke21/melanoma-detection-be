# Generated by Django 3.1.7 on 2021-03-20 17:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_classification', models.ForeignKey(default=0, on_delete=django.db.models.deletion.RESTRICT, to='melanoma_app.image_classification')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('region', models.ForeignKey(default=0, on_delete=django.db.models.deletion.RESTRICT, to='melanoma_app.region')),
            ],
        ),
        migrations.CreateModel(
            name='DoctorPatients',
